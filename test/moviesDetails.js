...
import moviesDetails from "../challenges/moviesDetails.js";

describe("moviesDetails.js", () => {
  it(
    "should return all the movie details",
    mochaAsync(async () => {
      try {
        const result = await moviesDetails.run([
          `https://www.omdbapi.com/?t=Mr.%20Nobody&y=&plot=short&apikey=trilogy`,
          `https://www.omdbapi.com/?t=Greatest%20Showman&y=&plot=short&apikey=trilogy`,
          `https://www.omdbapi.com/?t=Pulp%20Fiction&y=&plot=short&apikey=trilogy`,
        ]);
